    ...
    <nav className="fixed top-0 left-0 right-0 z-50 glass-nav h-20 flex items-center">
      <div className="container mx-auto px-6 flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <Link href="#podcasts" className="text-sm text-[#A3A3A3] hover:text-white transition-colors">Podcasts</Link>
          <Link href="https://about.chatakeinnoworks.com" className="text-sm text-[#A3A3A3] hover:text-white transition-colors">Company</Link>
        </div>
